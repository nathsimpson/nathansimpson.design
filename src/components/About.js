  ...
  render() {
    return(
      <main>
        ...
        <p>I am studying the Bachelor of Design (Visual Communication) at Western Sydney University in Parramatta NSW. After completing a web design unit, followed by 'Programming Fundamentals', I developed an interest in coding. Since then I have been an active student on TreeHouse, to learn JavaScript, React and Swift. I am also a regular attendee at <a href="https://www.sydjs.com/" target="_blank">SydJS</a> meetup events.</p>
        <p>I am currently working in an eLearning services company in North Sydney. On the side of my regular development, training and support roles, I have created an entire new website for the company, and created some custom automation software that integrates with their CRM. I am also still actively freelancing on the side of my work and uni.</p>
        <hr/>
