...
const Bio = () => (
  ...
  >
    <img
      src="https://www.nsgd.com.au/filesnathansimpsondesign/chair.jpg"
      css={{ width: "100%" }}
    />
    <div>
      <h2>About Nathan</h2>
      <p>
        Nathan Simpson is a junior UI Designer and Frontend Developer at{" "}
      ...
      <p>
        Nathan is a budding entrepreneur, and is interested with smart devices
        and automation. He would like to create experiences that allow users to
        monitor and automate their worlds. He would also like to speak at
        meetups and conferences, and help other up and coming designers and devs
        make a start to their careers.
      </p>
      <p>
